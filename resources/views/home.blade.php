    ...
    <div class="flex gap-5">
        @forelse($items as $item)
            <div
                ...
                <a href="#">
                    <img class="p-8 rounded-t-lg" src="{{ asset('storage/berkas/' . $item->file) }}" alt="product image" />
                </a>
                <div class="px-5 pb-5">
                    <a href="#">
                    ...
                    <div class="flex items-center justify-between">
                        <span class="text-3xl font-bold text-gray-900 dark:text-white">Rp. {{ $item->item_price }}</span>
